...
elseif (ARCH_AMD64)
    ...
    option (ENABLE_AVX512_VBMI "Use AVX512_VBMI instruction on x86_64 (depends on ENABLE_AVX512)" 1)
    option (ENABLE_BMI "Use BMI instructions on x86_64" 1)
    option (ENABLE_BMI2 "Use BMI2 instructions on x86_64 (depends on ENABLE_AVX2)" 1)
    ...
    if (NO_SSE3_OR_HIGHER)
        ...
        SET(ENABLE_AVX2 1)
        SET(ENABLE_AVX512 1)
        SET(ENABLE_AVX512_VBMI 1)
        SET(ENABLE_BMI 1)
        SET(ENABLE_BMI2 1)
        SET(ENABLE_AVX2_FOR_SPEC_OP 1)
        SET(ENABLE_AVX512_FOR_SPEC_OP 1)
    endif()
